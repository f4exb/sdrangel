...
void MainWindow::createStatusBar()
{
    ...
    m_showSystemWidget = new QLabel("SDRangel v3.7.1 " + qtVersionStr + QSysInfo::prettyProductName(), this);
#else
    m_showSystemWidget = new QLabel("SDRangel v3.7.1 " + qtVersionStr, this);
#endif
