...
void MainWindow::createStatusBar()
{
    ...
    m_showSystemWidget = new QLabel("SDRangel v3.4.4 " + qtVersionStr + QSysInfo::prettyProductName(), this);
#else
    m_showSystemWidget = new QLabel("SDRangel v3.4.4 " + qtVersionStr, this);
#endif
