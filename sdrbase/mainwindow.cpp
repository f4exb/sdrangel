...
void MainWindow::createStatusBar()
{
    ...
    m_showSystemWidget = new QLabel("SDRangel v3.4.3 " + qtVersionStr + QSysInfo::prettyProductName(), this);
#else
    m_showSystemWidget = new QLabel("SDRangel v3.4.3 " + qtVersionStr, this);
#endif
