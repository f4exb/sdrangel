...
struct SDRBASE_API APRSPacket {
    ...
    APRSPacket() :
        ...
        m_stormDirection(0),
        m_stormSpeed(0),
        m_stormSustainedWindSpeed(0),
        m_stormPeakWindGusts(0),
        m_stormCentralPresure(0),
        m_stormRadiusHurricanWinds(0),
        m_stormRadiusTropicalStormWinds(0),
        m_stormRadiusWholeGail(0),
