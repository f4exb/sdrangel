...
#ifndef DEVICES_PLUTOSDR_DEVICEJUPITERSDRSCAN_H_
#define DEVICES_PLUTOSDR_DEVICEJUPITERSDRSCAN_H_
...
class DEVICES_API DeviceJupiterSDRScan
{
public:
    struct DeviceScan
    {
...
#endif /* DEVICES_JUPITERSDR_DEVICEPLUTOSDRSCAN_H_ */
