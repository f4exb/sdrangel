...
#ifndef DEVICES_JUPITERSDR_DEVICEPLUTOSDR_H_
#define DEVICES_JUPITERSDR_DEVICEPLUTOSDR_H_
...
class DEVICES_API DeviceJupiterSDR
{
public:
    static DeviceJupiterSDR& instance();
    ...
    DeviceJupiterSDRBox* getDeviceFromURI(const std::string& uri);
    DeviceJupiterSDRBox* getDeviceFromSerial(const std::string& serial);
...
private:
    DeviceJupiterSDRScan m_scan;
};

#endif /* DEVICES_JUPITERSDR_DEVICEPLUTOSDR_H_ */
