...
JupiterSDRInputSettings::JupiterSDRInputSettings()
{
	resetToDefaults();
}

void JupiterSDRInputSettings::resetToDefaults()
{
...
QByteArray JupiterSDRInputSettings::serialize() const
{
...
bool JupiterSDRInputSettings::deserialize(const QByteArray& data)
{
...
void JupiterSDRInputSettings::translateRFPath(RFPath path, QString& s)
{
    switch(path)
    {
    case RFPATH_A_BAL:
...
void JupiterSDRInputSettings::translateGainMode(GainMode mode, QString& s)
{
    switch(mode)
    {
    case GAIN_MANUAL:
...
void JupiterSDRInputSettings::applySettings(const QStringList& settingsKeys, const JupiterSDRInputSettings& settings)
{
...
QString JupiterSDRInputSettings::getDebugString(const QStringList& settingsKeys, bool force) const
{
