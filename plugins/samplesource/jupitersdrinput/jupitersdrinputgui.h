...
#ifndef PLUGINS_SAMPLESOURCE_JUPITERSDRINPUT_JUPITERSDRINPUTGUI_H_
#define PLUGINS_SAMPLESOURCE_JUPITERSDRINPUT_JUPITERSDRINPUTGUI_H_
...
namespace Ui {
    class JupiterSDRInputGUI;
}

class JupiterSDRInputGui : public DeviceGUI {
    Q_OBJECT

public:
    explicit JupiterSDRInputGui(DeviceUISet *deviceUISet, QWidget* parent = 0);
    virtual ~JupiterSDRInputGui();
...
#endif /* PLUGINS_SAMPLESOURCE_JUPITERSDRINPUT_JUPITERSDRINPUTGUI_H_ */
