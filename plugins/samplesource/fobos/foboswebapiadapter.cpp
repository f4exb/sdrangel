...
int FOBOSWebAPIAdapter::webapiSettingsGet(
        ...
        QString& errorMessage)
{
    ...
    FOBOSInput::webapiFormatDeviceSettings(response, m_settings);
    return 200;
}

int FOBOSWebAPIAdapter::webapiSettingsPutPatch(
        bool force,
        ...
        QString& errorMessage)
{
    ...
    (void) errorMessage;
    FOBOSInput::webapiUpdateDeviceSettings(m_settings, deviceSettingsKeys, response);
    return 200;
}
