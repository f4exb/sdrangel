...
#ifndef _FOBOS_FOBOSGUI_H_
#define _FOBOS_FOBOSGUI_H_
...
class FOBOSGui : public DeviceGUI {
	Q_OBJECT

public:
	explicit FOBOSGui(DeviceUISet *deviceUISet, QWidget* parent = 0);
	virtual ~FOBOSGui();
...
private:
    ...
    bool openFobosOperatorSettingsDialog(const QPoint& p);
...
private:
    ...
    QString m_backendDetails;

};

#endif // _FOBOS_FOBOSGUI_H_
