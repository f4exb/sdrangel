...
#ifndef INCLUDE_FEATURE_MCPSERVERPLUGIN_H
#define INCLUDE_FEATURE_MCPSERVERPLUGIN_H
...
class MCPServerPlugin : public QObject, PluginInterface {
	Q_OBJECT
	Q_INTERFACES(PluginInterface)
	Q_PLUGIN_METADATA(IID "sdrangel.feature.mcpserver")
...
#endif // INCLUDE_FEATURE_MCPSERVERPLUGIN_H
