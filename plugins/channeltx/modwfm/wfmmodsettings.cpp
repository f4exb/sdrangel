...
void WFMModSettings::applySettings(const QStringList& settingsKeys, const WFMModSettings& settings)
{
...
QString WFMModSettings::getDebugString(const QStringList& settingsKeys, bool force) const
{
