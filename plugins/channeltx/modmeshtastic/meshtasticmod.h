...
#ifndef PLUGINS_CHANNELTX_MODMESHTASTIC_MESHTASTICMOD_H_
#define PLUGINS_CHANNELTX_MODMESHTASTIC_MESHTASTICMOD_H_
...
class DeviceAPI;
class CWKeyer;
class MeshtasticModBaseband;
class ObjectPipe;

class MeshtasticMod : public BasebandSampleSource, public ChannelAPI {
public:
    class MsgConfigureMeshtasticMod : public Message {
    ...
    public:
        ...
        static MsgConfigureMeshtasticMod* create(const MeshtasticModSettings& settings, bool force)
        {
            return new MsgConfigureMeshtasticMod(settings, force);
        }
    ...
    private:
        ...
        MsgConfigureMeshtasticMod(const MeshtasticModSettings& settings, bool force) :
            Message(),
            m_settings(settings),
            m_force(force)
        { }
...
private:
    ...
    QThread *m_thread;
    MeshtasticModBaseband* m_basebandSource;
    MeshtasticModEncoder m_encoder; // TODO: check if it needs to be on its own thread
    MeshtasticModSettings m_settings;
    ...
    void webapiReverseSendSettings(QList<QString>& channelSettingsKeys, const MeshtasticModSettings& settings, bool force);
...
#endif /* PLUGINS_CHANNELTX_MODMESHTASTIC_MESHTASTICMOD_H_ */
