...
#ifndef INCLUDE_MESHTASTICMODSOURCE_H
#define INCLUDE_MESHTASTICMODSOURCE_H
...
class MeshtasticModSource : public ChannelSampleSource
{
public:
    MeshtasticModSource();
    virtual ~MeshtasticModSource();
