...
#ifndef PLUGINS_CHANNELTX_MODMESHTASTIC_MESHTASTICMODENCODER_H_
#define PLUGINS_CHANNELTX_MODMESHTASTIC_MESHTASTICMODENCODER_H_

#include <vector>
#include "meshtasticmodsettings.h"

class MeshtasticModEncoder
{
public:
