...
#ifndef PLUGINS_CHANNELTX_MODMESHTASTIC_MESHTASTICMODENCODERTTY_H_
#define PLUGINS_CHANNELTX_MODMESHTASTIC_MESHTASTICMODENCODERTTY_H_

#include <vector>
#include <QString>

class MeshtasticModEncoderTTY
{
public:
...
#endif // PLUGINS_CHANNELTX_MODMESHTASTIC_MESHTASTICMODENCODERTTY_H_
