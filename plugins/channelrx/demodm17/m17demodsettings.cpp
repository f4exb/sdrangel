...
QString M17DemodSettings::getDebugString(const QStringList& settingsKeys, bool force) const
{
    ...
    if (settingsKeys.contains("statusLogEnabled") || force) {
        ostr << " m_statusLogEnabled: " << m_statusLogEnabled;
    }
