...
public:
    ...
    public:
        ...
        static MsgConfigureWFMDemod* create(const QStringList& settingsKeys, const WFMDemodSettings& settings, bool force)
        {
            return new MsgConfigureWFMDemod(settingsKeys, settings, force);
        }
    ...
    private:
        ...
        MsgConfigureWFMDemod(const QStringList& settingsKeys, const WFMDemodSettings& settings, bool force) :
            Message(),
            m_settings(settings),
...
private:
    ...
    void webapiReverseSendSettings(const QList<QString>& channelSettingsKeys, const WFMDemodSettings& settings, bool force);
