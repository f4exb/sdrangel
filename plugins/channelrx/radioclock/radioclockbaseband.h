...
public:
    ...
    public:
        ...
        static MsgConfigureRadioClockBaseband* create(const QStringList& settingsKeys, const RadioClockSettings& settings, bool force)
        {
            return new MsgConfigureRadioClockBaseband(settingsKeys, settings, force);
        }
    ...
    private:
        ...
        MsgConfigureRadioClockBaseband(const QStringList& settingsKeys, const RadioClockSettings& settings, bool force) :
            Message(),
            m_settings(settings),
