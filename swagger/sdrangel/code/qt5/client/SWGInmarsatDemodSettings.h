...
/*
 * SWGInmarsatDemodSettings.h
 *
 * InmarsatDemod
 */

#ifndef SWGInmarsatDemodSettings_H_
#define SWGInmarsatDemodSettings_H_
...
public:
    ...
    SWGInmarsatDemodSettings(QString* json);
    virtual ~SWGInmarsatDemodSettings();
    void init();
    void cleanup();
    ...
    virtual SWGInmarsatDemodSettings* fromJson(QString &jsonString) override;
    ...
    float getRrcRolloff();
    void setRrcRolloff(float rrc_rolloff);
...
#endif /* SWGInmarsatDemodSettings_H_ */
