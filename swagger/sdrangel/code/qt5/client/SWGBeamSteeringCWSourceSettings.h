...
/*
 * SWGBeamSteeringCWSourceSettings.h
 *
 * BeamSteeringCWSource
 */

#ifndef SWGBeamSteeringCWSourceSettings_H_
#define SWGBeamSteeringCWSourceSettings_H_
...
class SWG_API SWGBeamSteeringCWSourceSettings: public SWGObject {
public:
    SWGBeamSteeringCWSourceSettings();
    SWGBeamSteeringCWSourceSettings(QString* json);
    virtual ~SWGBeamSteeringCWSourceSettings();
    void init();
    void cleanup();
    ...
    virtual SWGBeamSteeringCWSourceSettings* fromJson(QString &jsonString) override;
...
#endif /* SWGBeamSteeringCWSourceSettings_H_ */
