...
/*
 * SWGMCPServerSettings.h
 *
 * MCP (Model Context Protocol) server settings
 */

#ifndef SWGMCPServerSettings_H_
#define SWGMCPServerSettings_H_
...
class SWG_API SWGMCPServerSettings: public SWGObject {
public:
    SWGMCPServerSettings();
    SWGMCPServerSettings(QString* json);
    virtual ~SWGMCPServerSettings();
    void init();
    void cleanup();
    ...
    virtual SWGMCPServerSettings* fromJson(QString &jsonString) override;
    ...
    void setCaptureDir(QString* capture_dir);
