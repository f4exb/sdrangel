...
qint32
SWGLoRaModSettings::getPreambleChirps() {
    return preamble_chirps;
}
void
SWGLoRaModSettings::setPreambleChirps(qint32 preamble_chirps) {
    this->preamble_chirps = preamble_chirps;
    this->m_preamble_chirps_isSet = true;
}

qint32
SWGLoRaModSettings::getQuietMillis() {
    return quiet_millis;
}
void
SWGLoRaModSettings::setQuietMillis(qint32 quiet_millis) {
    this->quiet_millis = quiet_millis;
    this->m_quiet_millis_isSet = true;
}

qint32
SWGLoRaModSettings::getSyncWord() {
    return sync_word;
}
void
SWGLoRaModSettings::setSyncWord(qint32 sync_word) {
...
qint32
SWGLoRaModSettings::getCodingScheme() {
    return coding_scheme;
}
void
SWGLoRaModSettings::setCodingScheme(qint32 coding_scheme) {
    this->coding_scheme = coding_scheme;
    this->m_coding_scheme_isSet = true;
}

qint32
SWGLoRaModSettings::getNbParityBits() {
    return nb_parity_bits;
}
void
SWGLoRaModSettings::setNbParityBits(qint32 nb_parity_bits) {
    this->nb_parity_bits = nb_parity_bits;
    this->m_nb_parity_bits_isSet = true;
}

qint32
SWGLoRaModSettings::getHasCrc() {
    return has_crc;
}
void
SWGLoRaModSettings::setHasCrc(qint32 has_crc) {
    this->has_crc = has_crc;
    this->m_has_crc_isSet = true;
}

qint32
SWGLoRaModSettings::getHasHeader() {
    return has_header;
}
void
SWGLoRaModSettings::setHasHeader(qint32 has_header) {
    this->has_header = has_header;
    this->m_has_header_isSet = true;
}

QString*
SWGLoRaModSettings::getMyCall() {
    return my_call;
}
void
SWGLoRaModSettings::setMyCall(QString* my_call) {
    this->my_call = my_call;
    this->m_my_call_isSet = true;
}

QString*
SWGLoRaModSettings::getUrCall() {
    return ur_call;
}
void
SWGLoRaModSettings::setUrCall(QString* ur_call) {
    this->ur_call = ur_call;
    this->m_ur_call_isSet = true;
}

QString*
SWGLoRaModSettings::getMyLoc() {
    return my_loc;
}
void
SWGLoRaModSettings::setMyLoc(QString* my_loc) {
    this->my_loc = my_loc;
    this->m_my_loc_isSet = true;
}

QString*
SWGLoRaModSettings::getMyRpt() {
    return my_rpt;
}
void
SWGLoRaModSettings::setMyRpt(QString* my_rpt) {
    this->my_rpt = my_rpt;
    this->m_my_rpt_isSet = true;
}

qint32
SWGLoRaModSettings::getMessageType() {
    return message_type;
}
void
SWGLoRaModSettings::setMessageType(qint32 message_type) {
    this->message_type = message_type;
    this->m_message_type_isSet = true;
}

QString*
SWGLoRaModSettings::getBeaconMessage() {
    return beacon_message;
}
void
SWGLoRaModSettings::setBeaconMessage(QString* beacon_message) {
    this->beacon_message = beacon_message;
    this->m_beacon_message_isSet = true;
}

QString*
SWGLoRaModSettings::getCqMessage() {
    return cq_message;
}
void
SWGLoRaModSettings::setCqMessage(QString* cq_message) {
    this->cq_message = cq_message;
    this->m_cq_message_isSet = true;
}

QString*
SWGLoRaModSettings::getReplyMessage() {
    return reply_message;
}
void
SWGLoRaModSettings::setReplyMessage(QString* reply_message) {
    this->reply_message = reply_message;
    this->m_reply_message_isSet = true;
}

QString*
SWGLoRaModSettings::getReportMessage() {
    return report_message;
}
void
SWGLoRaModSettings::setReportMessage(QString* report_message) {
    this->report_message = report_message;
    this->m_report_message_isSet = true;
}

QString*
SWGLoRaModSettings::getReplyReportMessage() {
    return reply_report_message;
}
void
SWGLoRaModSettings::setReplyReportMessage(QString* reply_report_message) {
    this->reply_report_message = reply_report_message;
    this->m_reply_report_message_isSet = true;
}

QString*
SWGLoRaModSettings::getRrrMessage() {
    return rrr_message;
}
void
SWGLoRaModSettings::setRrrMessage(QString* rrr_message) {
    this->rrr_message = rrr_message;
    this->m_rrr_message_isSet = true;
}

QString*
SWGLoRaModSettings::getMessage73() {
    return message73;
}
void
SWGLoRaModSettings::setMessage73(QString* message73) {
    this->message73 = message73;
    this->m_message73_isSet = true;
}

QString*
SWGLoRaModSettings::getQsoTextMessage() {
    return qso_text_message;
}
void
SWGLoRaModSettings::setQsoTextMessage(QString* qso_text_message) {
    this->qso_text_message = qso_text_message;
    this->m_qso_text_message_isSet = true;
}

QString*
SWGLoRaModSettings::getTextMessage() {
    return text_message;
}
void
SWGLoRaModSettings::setTextMessage(QString* text_message) {
    this->text_message = text_message;
    this->m_text_message_isSet = true;
}

QList<QString*>*
SWGLoRaModSettings::getBytesMessage() {
    return bytes_message;
}
void
SWGLoRaModSettings::setBytesMessage(QList<QString*>* bytes_message) {
    this->bytes_message = bytes_message;
    this->m_bytes_message_isSet = true;
}

qint32
SWGLoRaModSettings::getMessageRepeat() {
    return message_repeat;
}
void
SWGLoRaModSettings::setMessageRepeat(qint32 message_repeat) {
