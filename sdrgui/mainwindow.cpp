...
void MainWindow::createStatusBar()
{
    ...
    m_showSystemWidget = new QLabel("SDRangel v3.8.0 " + qtVersionStr + QSysInfo::prettyProductName(), this);
#else
    m_showSystemWidget = new QLabel("SDRangel v3.8.0 " + qtVersionStr, this);
#endif
